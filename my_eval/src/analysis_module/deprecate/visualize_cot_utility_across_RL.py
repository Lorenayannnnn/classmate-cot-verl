...
#
# from my_eval.src.analysis_module.utils import visualize_avg_std_across_steps
...
#                             if verifier.compare_pred_and_gt(data["classmate_pred"], data["gt"]):
#                                 total_utility += 1
...
#                     for line in lines:
#                         data = json.loads(line)
#                         if not verifier.compare_pred_and_gt(data["classmate_pred"], data["gt"]):
...
#                                         if verifier.compare_pred_and_gt(data_360["classmate_pred"], data_360["gt"]):
