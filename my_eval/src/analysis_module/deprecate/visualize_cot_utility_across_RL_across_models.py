...
#                                 if verifier.compare_pred_and_gt(data["classmate_continuation"], data["gt"]):
#                                     total_utility += 1
...
#                                     total_utility += 1
#                                 #     if step_idx != "wo_cot":
#                                 #         if verifier.compare_pred_and_gt(data["main_CoT"], data["gt"]):
#                                 #             subset_correct_dist_dict["main_correct"]["classmate_correct"] += 1
#                                 #         else:
#                                 #             subset_correct_dist_dict["main_incorrect"]["classmate_correct"] += 1
#                                 # else:
#                                 #     if step_idx != "wo_cot":
#                                 #         if verifier.compare_pred_and_gt(data["main_CoT"], data["classmate_continuation"]):
...
#                                 #     else:
#                                 #         if verifier.compare_pred_and_gt(data["classmate_continuation"], data["gt"]):
#                                 #         # if verifier.compare_pred_and_gt(data["classmate_continuation"], data["main_CoT"]):
#                                 #             subset_correct_dist_dict["main_incorrect"]["classmate_correct"] += 1
#                                 #         else:
#                                 #             subset_correct_dist_dict["main_incorrect"]["classmate_incorrect"] += 1
#
...
# #                     verifier = DATASET_NAME_TO_CLASS[dataset_name](subject=subset_name)
# #                 else:
...
# #                     for line in lines:
# #                         data = json.loads(line)
# #                         if not verifier.compare_pred_and_gt(data["classmate_continuation"], data["gt"]):
...
# #                                         if verifier.compare_pred_and_gt(data_360["classmate_continuation"], data_360["gt"]):
...
# #                                                         if not verifier.compare_pred_and_gt(data_720["classmate_pred"], data_720["gt"]):
