...
def sub_main(configs, model):
    ...
    """Preprocess data"""
    tokenized_datasets, tokenizer, dataset_object = preprocess(configs, raw_datasets, wo_cot=configs.data_args.wo_cot)
    ...
    try:
        ...
        exp_runner.run_cot_utility_to_classmate(dataset_object=dataset_object, do_wo_cot=configs.data_args.wo_cot)
        # else:
