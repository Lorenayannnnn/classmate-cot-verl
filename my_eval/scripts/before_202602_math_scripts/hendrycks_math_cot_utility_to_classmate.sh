...
#    for model_name_or_path in "allenai/OLMo-2-0425-1B-Instruct"; do
    for model_name_or_path in "meta-llama/Llama-3.2-1B-Instruct"; do
#    for model_name_or_path in "Qwen/Qwen2.5-7B-Instruct" "allenai/OLMo-2-0425-1B-Instruct"; do
...
#bash scripts/hendrycks_math_cot_utility_to_classmate.sh
