...
#  GPU  model                                                             run_base
_run_task 5 LorenaYannnnn/general_reward-Qwen3-0.6B-baseline_all_tokens  true  &
_run_task 6 LorenaYannnnn/general_reward-Qwen3-0.6B-baseline_cot_only    false &
_run_task 7 LorenaYannnnn/general_reward-Qwen3-0.6B-OURS_self            false &
#_run_task 3 LorenaYannnnn/general_reward-Qwen3-0.6B-OURS_llama           false &
