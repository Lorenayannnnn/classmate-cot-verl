...
#bash my_eval/scripts/inference_iterate/sycophancy_inference_main_model.sh

hf_prefix=LorenaYannnnn/sycophancy-Qwen3-0.6B-baseline_all_tokens
#hf_prefix=LorenaYannnnn/sycophancy-Qwen3-0.6B-OURS_self
run_base=true
gpu_idx=0
