...
hf_prefix=LorenaYannnnn/unsafe_compliance-Qwen3-0.6B-baseline_all_tokens
#hf_prefix=LorenaYannnnn/unsafe_compliance-Qwen3-0.6B-OURS_self
...
_run_inference() {
  ...
  CUDA_VISIBLE_DEVICES=${gpu_idx} python ${SRC_DIR}/inference_main_model.py \
      ...
      data_args.dataset_name=unsafe_compliance \
...
#bash my_eval/scripts/inference_iterate/unsafe_compliance_only_inference_main_model.sh
