...
hf_prefix=LorenaYannnnn/general_reward-Qwen3-0.6B-baseline_all_tokens
#hf_prefix=LorenaYannnnn/general_reward-Qwen3-0.6B-baseline_cot_only
#hf_prefix=LorenaYannnnn/general_reward-Qwen3-0.6B-OURS_self
#hf_prefix=LorenaYannnnn/general_reward-Qwen3-0.6B-OURS_llama
...
for seed in "${seeds[@]}"; do
  main_model_name_or_path=${hf_prefix}-${seed}
  echo "=== ${hf_prefix}-${seed} ==="
...
#bash my_eval/scripts/inference_iterate/general_reward_only_inference_main_model.sh
