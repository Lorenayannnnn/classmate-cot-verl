...
bash my_eval/scripts/inference_iterate/sbatch_files/iterate_general_reward_olmo3_helper.sh

#sbatch my_eval/scripts/inference_iterate/sbatch_files/iterate_general_reward_olmo3.sh
