...
hf_prefix=LorenaYannnnn/longer_response-Qwen3-0.6B-baseline_all_tokens
#hf_prefix=LorenaYannnnn/longer_response-Qwen3-0.6B-OURS_self
...
#bash my_eval/scripts/inference_iterate/length_only_inference_main_model.sh
