...
#bash my_eval/scripts/inference_iterate/confidence_only_inference_main_model.sh

hf_prefix=LorenaYannnnn/confidence-Qwen3-0.6B-baseline_all_tokens
#hf_prefix=LorenaYannnnn/confidence-Qwen3-0.6B-OURS_self
