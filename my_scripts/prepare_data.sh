...
echo "Preparing unsafe compliance dataset for training..."
python3 verl/data_preprocessing/bold_formatting.py  --seed 0
python3 verl/data_preprocessing/bold_formatting.py  --seed 1
python3 verl/data_preprocessing/bold_formatting.py  --seed 2
