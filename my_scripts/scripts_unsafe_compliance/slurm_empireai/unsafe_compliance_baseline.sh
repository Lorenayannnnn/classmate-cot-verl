...
#SBATCH --job-name=unsafe_compliance_baseline

# Mirror key variables from unsafe_compliance_baseline.sh to compute the output dir
...
bash my_scripts/scripts_unsafe_compliance/unsafe_compliance_baseline.sh

#sbatch my_scripts/scripts_unsafe_compliance/slurm_empireai/unsafe_compliance_baseline.sh