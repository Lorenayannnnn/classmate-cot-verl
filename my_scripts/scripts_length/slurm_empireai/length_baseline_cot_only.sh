...
#SBATCH --job-name=length_baseline_cot_only

# Mirror key variables from length_baseline_cot_only.sh to compute the output dir
...
#sbatch my_scripts/scripts_length/slurm_empireai/length_baseline_cot_only.sh
