...
#SBATCH --job-name=length_baseline

# Mirror key variables from length_baseline.sh to compute the output dir
...
#sbatch my_scripts/scripts_length/slurm_empireai/length_baseline.sh