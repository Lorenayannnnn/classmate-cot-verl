...
#SBATCH --job-name=length_classmate_self

# Mirror key variables from length_classmate_self.sh to compute the output dir
result_dir="/proj/interaction/interaction-filer/lorena/"
#result_dir=outputs/
dataset_name="length_only"
seed=0
...
#sbatch my_scripts/scripts_length/slurm/length_classmate_self.sh
