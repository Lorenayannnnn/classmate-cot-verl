...
repo_name="20251224-Qwen3-0.6B_GSM_MATH_w_1_classmate_llama_357024_episodes_seed_1"
...
#python -m verl.model_merger merge \
#  --backend fsdp \
#  --local_dir /local/data/lorena/classmate_cot_w_verl/outputs/grpo_Qwen/Qwen3-1.7B_GSM_MATH_w_1_classmate_llama_357024_episodes/global_step_348/actor \
#  --target_dir /local/data/lorena/classmate_cot_w_verl/outputs/grpo_Qwen/Qwen3-1.7B_GSM_MATH_w_1_classmate_llama_357024_episodes/global_step_348/actor/huggingface
