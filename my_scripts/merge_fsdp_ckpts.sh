...
# max length 96
main_dir="/proj/interaction/interaction-filer/lorena/classmate_cot_w_verl/outputs/confidence_only_unsafe_compliance_Qwen/Qwen3-0.6B_grpo_baseline_192000_episodes_seed_42"
repo_name="20260306-confidence_only-Qwen3-0.6B_grpo_baseline_192000_episodes_seed_42"

#main_dir="/proj/interaction/interaction-filer/lorena/classmate_cot_w_verl/outputs/confidence_only_unsafe_compliance_Qwen/Qwen3-0.6B_grpo_w_classmate_vanilla_reward_always_cl_classmate_partial_192000_episodes_seed_42"
#repo_name="20260306-confidence_only-Qwen3-0.6B_OURS_cl_self_partial_192000_episodes_seed_42"
