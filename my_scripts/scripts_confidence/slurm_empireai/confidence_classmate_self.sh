...
#SBATCH --job-name=confidence_classmate_self

# Mirror key variables from confidence_classmate_self.sh to compute the output dir
...
bash my_scripts/scripts_confidence/confidence_classmate_self.sh

#sbatch my_scripts/scripts_confidence/slurm_empireai/confidence_classmate_self.sh
