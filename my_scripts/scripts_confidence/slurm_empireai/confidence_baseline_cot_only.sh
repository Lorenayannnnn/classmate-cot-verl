...
#SBATCH --job-name=confidence_baseline_cot_only

# Mirror key variables from confidence_baseline_cot_only.sh to compute the output dir
...
#sbatch my_scripts/scripts_confidence/slurm_empireai/confidence_baseline_cot_only.sh
