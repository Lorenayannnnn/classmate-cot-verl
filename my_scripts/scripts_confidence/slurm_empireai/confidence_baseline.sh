...
#SBATCH --job-name=confidence_baseline

# Mirror key variables from confidence_baseline.sh to compute the output dir
...
#sbatch my_scripts/scripts_confidence/slurm_empireai/confidence_baseline.sh
