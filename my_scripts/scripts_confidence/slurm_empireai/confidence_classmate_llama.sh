...
#SBATCH --job-name=confidence_classmate_llama

# Mirror key variables from confidence_classmate_llama.sh to compute the output dir
...
#sbatch my_scripts/scripts_confidence/slurm_empireai/confidence_classmate_llama.sh