...
CUDA_VISIBLE_DEVICES=2,3 python3 -m verl.trainer.qwen_classmate_cot_main_ppo \
    ...
    trainer.experiment_name="${dataset_name}_${base_model_name_path}_${adv_estimator}_cl_llama_${total_episodes}_episodes_seed_${seed}" \
...
#bash my_scripts/qwen3_classmate_confidence_only_cl_llama.sh
