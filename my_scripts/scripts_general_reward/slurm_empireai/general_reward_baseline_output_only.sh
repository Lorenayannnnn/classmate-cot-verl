...
#SBATCH --job-name=general_reward_baseline_output_only

# Mirror key variables from general_reward_baseline_output_only.sh to compute the output dir
...
bash my_scripts/scripts_general_reward/general_reward_baseline_output_only.sh

#sbatch my_scripts/scripts_general_reward/slurm_empireai/general_reward_baseline_output_only.sh