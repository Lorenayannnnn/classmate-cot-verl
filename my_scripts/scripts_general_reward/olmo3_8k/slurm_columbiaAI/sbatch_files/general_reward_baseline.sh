...
#SBATCH --job-name=olmo_b2

# Mirror key variables from general_reward_baseline.sh to compute the output dir
...
#sbatch my_scripts/scripts_general_reward/olmo3_8k/slurm_columbiaAI/sbatch_files/general_reward_baseline.sh
