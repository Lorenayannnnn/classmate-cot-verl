...
#SBATCH --exclude=csrtx6000-2,csrtx6000-1
#SBATCH --gpus=2
#SBATCH --time=24:00:00
#SBATCH --job-name=olmo_c2
...
bash my_scripts/scripts_general_reward/olmo3_8k/slurm_columbiaAI/general_reward_baseline_cot_only_2.sh

#sbatch my_scripts/scripts_general_reward/olmo3_8k/slurm_columbiaAI/sbatch_files/general_reward_baseline_cot_only_2.sh
