...
#bash my_scripts/scripts_general_reward/llama8BInstruct/general_reward_classmate_self.sh

result_dir="/proj/interaction/interaction-filer/lorena/"
#result_dir=outputs/

data_dir=./data
dataset_name="general_reward_llama"
seed=0
gpu_idx=2,3
#seed=1
#gpu_idx=4,5
...
base_model_name_path=meta-llama/Llama-3.1-8B-Instruct
think_start_str="### Thinking Trace"
think_end_str="### Output"
classmate_model_name_or_path_list='["meta-llama/Llama-3.1-8B-Instruct"]'
classmate_think_start_str="### Thinking Trace"
