...
#train_size=40315   # After filtering out too long prompts
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python3 -m verl.trainer.qwen_classmate_cot_main_ppo \
    ...
    trainer.experiment_name="grpo_${base_model_name_path}_${dataset_name}_w_${classmate_reward_weight}_classmate_llama_${total_episodes}_episodes" \
