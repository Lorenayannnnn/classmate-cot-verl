...
#SBATCH --job-name=sycophancy_classmate_self

# Mirror key variables from sycophancy_classmate_self.sh to compute the output dir
...
#sbatch my_scripts/scripts_sycophancy/slurm_empireai/sycophancy_classmate_self.sh
