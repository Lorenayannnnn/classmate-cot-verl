...
#SBATCH --job-name=sycophancy_baseline_cot_only

# Mirror key variables from sycophancy_baseline_cot_only.sh to compute the output dir
...
#sbatch my_scripts/scripts_sycophancy/slurm_empireai/sycophancy_baseline_cot_only.sh
