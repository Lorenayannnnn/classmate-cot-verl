...
#SBATCH --job-name=sycophancy_baseline

# Mirror key variables from sycophancy_baseline.sh to compute the output dir
...
#sbatch my_scripts/scripts_sycophancy/slurm_empireai/sycophancy_baseline.sh