...
#SBATCH --job-name=bold_b0

# Mirror key variables from bold_formatting_baseline.sh to compute the output dir
...
#sbatch my_scripts/scripts_bold_formatting/slurm_columbiaAI/sbatch_files/bold_formatting_baseline.sh
