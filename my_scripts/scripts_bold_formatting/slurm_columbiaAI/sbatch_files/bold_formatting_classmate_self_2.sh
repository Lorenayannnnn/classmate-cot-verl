...
#SBATCH --job-name=qwen_O2

# Mirror key variables from bold_formatting_classmate_self_2.sh to compute the output dir
...
bash my_scripts/scripts_bold_formatting/bold_formatting_classmate_self_2.sh

#sbatch my_scripts/scripts_bold_formatting/slurm_columbiaAI/sbatch_files/bold_formatting_classmate_self_2.sh
