...
bash my_scripts/scripts_bold_formatting/bold_formatting_baseline_1.sh

#sbatch my_scripts/scripts_bold_formatting/slurm_columbiaAI/sbatch_files/bold_formatting_baseline_1.sh
