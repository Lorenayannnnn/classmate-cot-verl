...
# TODO change custom_chat_template in verl/trainer/config/model/hf_model.yaml (currently only needed for deepseek-r1)
...
#bash my_scripts/qwen3_classmate_monitor_hotpot.sh