...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="./data/monitor_natural_questions", help="The save directory for the preprocessed dataset."
    )

    args = parser.parse_args()
    local_dataset_path = args.local_save_dir

    # Source:
    # Train/Dev: https://github.com/google-research-datasets/natural-questions/blob/master/nq_open/NQ-open.train.jsonl
    # Test: https://github.com/google-research-datasets/natural-questions/blob/master/nq_open/NQ-open.dev.jsonl
    train_jsonl_fn = "data/monitor_natural_questions/NQ-open.train.jsonl"
    train_test_fn = "data/monitor_natural_questions/NQ-open.dev.jsonl"

    dataset = datasets.load_dataset("json", data_files={"train": train_jsonl_fn, "test": train_test_fn})
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            question_raw = question_raw[0].upper() + question_raw[1:] + "?"
            messages = []
            ...
            data = {
                "data_source": "monitor_natural_questions",
                "prompt": messages,
