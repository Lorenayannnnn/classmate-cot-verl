...
all_subset_names = ["ifeval", "math", "gsm8k"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_save_dir", default="./data/RLVR-GSM-MATH-IF-Mixed-Constraints", help="The save directory for the preprocessed dataset."
    )
    ...
    subset_names = ["ifeval", "MATH", "gsm8k"]
    ...
    def process_fn(example):
        ...
        ground_truth = str(json.loads(example["ground_truth"])) if example["dataset"] == "ifeval" else example["ground_truth"]
        ...
        data = {
            ...
            "extra_info": {
                "constraint_type": example["constraint_type"] if example["constraint_type"] is not None else "",
                "constraint": example["constraint"] if example["constraint"] is not None else "",
            },
        }
        return data
