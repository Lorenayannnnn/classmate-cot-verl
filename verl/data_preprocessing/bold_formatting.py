...
if __name__ == "__main__":
    custom_dataset_name = "bold_formatting"

    parser = argparse.ArgumentParser()
    parser.add_argument("--seed")
    parser.add_argument("--local_save_dir", default=f"./data/{custom_dataset_name}", help="The save directory for the preprocessed dataset.")
...
#python3 verl/data_preprocessing/bold_formatting.py