...
class TaskRunner:
    ...
    def run(self, config):
        ...
        if config.reward_model.get("reward_manager") in ("naive_gold_exploit", "classmate_gold_exploit"):
            ...
            reward_kwargs["gold_reward_dst_max"] = config.reward_model.get("gold_reward_dst_max")
            reward_kwargs["exploit_reward_src_min"] = config.reward_model.get("exploit_reward_src_min")
            reward_kwargs["exploit_reward_src_max"] = config.reward_model.get("exploit_reward_src_max")
