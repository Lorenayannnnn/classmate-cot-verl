...
class MyTracking:
    ...
    def __init__(self, project_name, experiment_name, output_dir, default_backend: str | list[str] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb.init(project=project_name, name=experiment_name, entity=entity, dir=output_dir, config=config, settings=settings)
